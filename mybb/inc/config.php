...
$config['database']['database'] = 'if0_35593877_556';
$config['database']['table_prefix'] = 'mybbjl_';

$config['database']['hostname'] = 'sql110.byetcluster.com';
$config['database']['username'] = '35593877_1';
$config['database']['password'] = 'S@A7p61C]u';
